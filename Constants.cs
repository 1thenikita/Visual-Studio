namespace DiscordRPforVS
{
    ...
    public static class Constants
    {
        ...
        {
            { new String[] { ".H", ".C" }, new String[] { "c", "C" } },
            { new String[] { ".CC", ".HH", ".CPP", ".IPP", ".INL", ".C++", ".H++", ".HPP" }, new String[] { "cpp", "C++" } },
            ...
            { new String[] { "CMAKELISTS.TXT", "CMAKECACHE.TXT", ".CMAKE" }, new String[] { "cmake", "CMake" } },
